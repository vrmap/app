// https://www.example.com/pagina.html?annoInizio=01/01/2005&annoFine=31/12/2017


// Recupero la stringa di query dell'URL
const queryString = window.location.search;

// Rimuovo il "?" iniziale dalla stringa di query
const queryParams = new URLSearchParams(queryString.substring(1));

// Recupero il valore del parametro "annoInizio"
const dataInizio = queryParams.get("dataInizio");

// Recupero il valore del parametro "annoFine"
const dataFine = queryParams.get("dataFine");

// Converto le date nel formato "YYYY-MM-DD" utilizzando Moment.js
const dataInizioISO = moment(dataInizio, "DD/MM/YYYY").format("YYYY-MM-DD");
const dataFineISO = moment(dataFine, "DD/MM/YYYY").format("YYYY-MM-DD");

console.log("Anno inizio: " + dataInizio);
console.log("Anno fine: " + dataFine);

// Utilizzo delle date nel formato "YYYY-MM-DD"
console.log("Anno inizio (ISO): " + dataInizioISO);
console.log("Anno fine (ISO): " + dataFineISO);
